...
$(function() {
    ...
     var h = d.getHours(); 
     ...
     var hello=["HELLO","HI", "HELLO NIKKY","HEY THERE","HEY","HI DUDE","HI TESTY BOT"];
     var gm=["GM","GOOD MORNING","GOOD MORNING NIKKY AMRESH", "GOOD MORNING TESTY BOT"];
    ...
    isInArray(bye, lastmsg)==true?(smsg="Thanks for asking me, ☺️..... Bye", k=smsg, 
    ...
    //  (smsg="Sorry, I have no answer for that. If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search Python</b>",k="Sorry, I have no answer for that. ")
    ...
    $.getJSON('/chatbot', {
        ...
        masg:lastmsg,
         ...
         if (data.data==="FAIL"){
            smsg="Sorry, I have no answer for that. If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search Python</b>"
            k="Sorry, I have no answer for that. "
